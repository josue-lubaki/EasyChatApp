package com.alithya.sequoia.features.login
        ...
        Konsist
            ...
            .assertArchitecture {
                ...
                val presentation = Layer(
                    name = "presentation",
                    definedBy = "com.alithya.features.login.presentation.."
                )
                val domain = Layer(
                    name = "domain",
                    definedBy = "com.alithya.features.login.domain.."
                )
                val data = Layer(
                    name = "data",
                    definedBy = "com.alithya.features.login.data.."
                )
